...
[{if $oView->getActiveRecommList() }]
    ...
    <div class="box info">
[{*MUDE_AVATAR_BEGIN*}]
      <div class="mude_avatar_review_pic"><img src="[{$_actvrecommlist->getMudeAvatarUrl()}]" ></div>
[{*MUDE_AVATAR_BEGIN*}]
      <div class="right">
          [{ if !$oxcmp_user}]
...
[{*MUDE_AVATAR_BEGIN*}]
    <div class="mude_avatar_review_list">
        <div class="mude_avatar_review_pic">
            <img src="[{$review->getMudeAvatarUrl()}]" >
        </div>
        <div class="mude_avatar_review">
[{*MUDE_AVATAR_END*}]
        <dl class="review">
            <dt>
