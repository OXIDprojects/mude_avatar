    ...
    <table width="100%">
      ...
      <tr>
        <td valign="top">
            ...
            <dl class="lastInCol">
                <dt><a id="test_link_account_avatar" class="[{if $active_link == 10}]active[{/if}]" href="[{ oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=mude_account_avatar" }]" rel="nofollow">[{ oxmultilang ident="MUDE_ACCOUNT_AVATAR" }]</a></dt>
                <dd id="test_link_account_orderDesc">[{ oxmultilang ident="MUDE_ACCOUNT_AVATAR_SUBLINE" }]</dd>
            </dl>
        </td>
        <td valign="top">
            <dl>
